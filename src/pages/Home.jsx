    ...
    return (
      <div style={{ background: "#0a0a0a", minHeight: "100vh", direction: "rtl", fontFamily: "Arial, sans-serif", color: "#fff" }}>
        ...
        <div style={{ padding: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {activeEps.map((ep, i) => (
              <div key={ep.id} onClick={() => openWithKalturaRefresh(ep)} style={{ display: "flex", gap: 12, padding: "12px 0", borderBottom: "1px solid #222", cursor: "pointer", alignItems: "center" }}>
        ...
        <header style={{ padding: "14px 14px 0", background: "#0a0a0a", borderBottom: "1px solid #1a1a1a" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
            ...
            <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.06)", padding: "9px 14px", borderRadius: 50, border: "1px solid #333" }}>
              ...
              <input type="text" placeholder="חפש סרט או סדרה..." value={searchTerm} onChange={e => { setSearchTerm(e.target.value); setVisibleCount(40); }} style={{ background: "none", border: "none", outline: "none", width: "100%", fontSize: 15, color: "#fff" }} />
