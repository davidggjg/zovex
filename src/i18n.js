...
const STRINGS = {
  he: {
    ...
    'home.downloadApp': 'אפליקציית ZOVEX לאנדרואיד ולטלוויזיה',
    'home.downloadAppSub': 'אותה אפליקציה לטלפון, לטאבלט ול‑Android TV · מתעדכנת מעצמה',
    'detail.play': 'הפעל',
  ...
  en: {
    ...
    'home.downloadApp': 'ZOVEX app for Android and TV',
    'home.downloadAppSub': 'One app for phone, tablet and Android TV · always the latest build',
    'detail.play': 'Play',
...
// ── שמות קטגוריות ────────────────────────────────────────────────────────────
// הקטגוריות הן נתונים ולא ממשק — הן מגיעות מהקטלוג בעברית. במקום לשנות את
// הנתונים (מה שהיה שובר את הסינון בכל מקום), מתרגמים אותן רק לתצוגה.
// קטגוריה שאינה במפה מוצגת כמו שהיא, כך שקטגוריה חדשה לא שוברת כלום.
const CATEGORIES_EN = {
  'הכל': 'All',
