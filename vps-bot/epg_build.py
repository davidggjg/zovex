...
# HOT: 20,663 תוכניות אבל **אפס שמות ערוצים** — התשובה מכילה programsDetails
#      בלבד, וכל תוכנית נושאת channelID בלי שם. לכן חיפוש לפי שם ערוץ שם
#      חסר טעם מעצם בנייתו, וזיהוי נעשה לפי תוכן:
#          python3 fix_channel_meta.py --hot-hunt ufc
#          python3 fix_channel_meta.py --hot-hunt hbo --days 2
#      מריצים מהשרת (HOT מחזיר 302 בלופ לכל מי שאינו דפדפן). אם יימצא ערוץ
#      עם שיעור התאמה גבוה — הקוד מודפס מוכן להדבקה כאן. עד אז אין להמציא.
MAP = {
    # חדשות וערוצים
