...
# נשאר לבדוק את HOT ואת yes, ושניהם אינם נגישים מכאן — HOT מחזיר 302 בלופ
# לכל מי שאינו דפדפן, ו-yes הוא תצלום ידני שיושב על השרת. לכן:
#     python3 fix_channel_meta.py --scan-all --pattern 'hbo|סלקום|ufc|לחימה'
# מריצים מהשרת, והפלט נותן את הקוד להדביק כאן. עד אז אין להמציא להם קוד.
MAP = {
    # חדשות וערוצים
